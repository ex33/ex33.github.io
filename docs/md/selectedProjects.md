...
<div class="project-card">
    <div class="project-content">
        ...
        <div class="project-venue">UK AISI Challenge Fund • Preprint</div>
        <div class="project-authors">J Rosser, Robert Kirk, Edward Grefenstette, Jakob Foerster, Laura Ruis</div>
